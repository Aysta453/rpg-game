...
export const createDungeons = (formData) => API.post(`/dungeons/createDungeons`, formData);
export const showDungeons = (formData) => API.post(`/dungeons/showDungeons`, formData);
export const newDungeons = (formData) => API.post(`/dungeons/newDungeons`, formData);
...
export const leaveRoom = (formData) => API.post(`/rooms/leaveRoom`, formData);
