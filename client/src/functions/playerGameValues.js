...
export default function playerGameValues(hero, itemsInUse, stats, passsiveSkills) {
  ...
  switch (hero.heroClass) {
    case "Mage":
      ...
      chanceOnDodge = logCalc(1.5, (dexterity + spirit / 10) / 10);
      chanceOnBlock = logCalc(1.6, (strength + sumStatsFromItemsDefensive + spirit / 10) / 10);
      chanceOnCritHit = logCalc(1.2, intellect + spirit / 10);
    ...
    case "Warrior":
      ...
      chanceOnDodge = logCalc(1.4, dexterity + spirit / 10 / 10);
      chanceOnBlock = logCalc(1.15, (strength + sumStatsFromItemsDefensive + spirit / 10) / 10);
      chanceOnCritHit = logCalc(1.3, (strength + spirit) / 10);
      chanceOnHit = logCalc(1.06, (dexterity + strength + intellect + spirit / 10) / hero.level);
      regHp = 1;
      regMp = 1;
    ...
    case "Hunter":
      ...
      chanceOnDodge = logCalc(1.2, chanceOnDodge + bp9);
