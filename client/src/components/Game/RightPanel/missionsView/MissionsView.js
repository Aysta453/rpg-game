    ...
    return(<>
        <div className='missionsView'>
            ...
            <div className='missions'>
                <MissionView submitClick={submitClick} missionType={1} setButtons={setButtons}  setWindowOfElements={setWindowOfElements} mission={missions.firstMission}/>
                <MissionView submitClick={submitClick} missionType={2} setButtons={setButtons}  setWindowOfElements={setWindowOfElements} mission={missions.secondMission}/>
                <MissionView submitClick={submitClick} missionType={3} setButtons={setButtons}  setWindowOfElements={setWindowOfElements} mission={missions.thirdMission}/>
