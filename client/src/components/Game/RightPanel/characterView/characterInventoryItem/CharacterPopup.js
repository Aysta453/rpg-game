...
const CharacterPopup = ({ valueOfPoup, showPopup, specyficItem, handleChangeItemIntoUse, slotNumber, sellThisItem }) => {
  ...
  return valueOfPoup ? (
    <div className="popup-inventoryItem">
      <div className="inventoryItem-inner">
        ...
        <div className="image">
          <img src={`/images/eq${image}.png`} alt="" />
        </div>
        <div className="typeOfItem">{typeOfItem}</div>
        <div className="infoAboutItem">
          <div className="undertitle">Statystyki</div>
          <div className="stats">
            <div className="values">
              {specyficItem.minAttack !== 0 || specyficItem.maxAttack !== 0 ? (
                <div className="row">
                  <div className="statName">
                    <p className={"dmg"}>
                      <span className={"dmgd"}>Obrażenia:</span>
                    </p>
                  </div>
                  <div className="statValue">
                    <p className={"dmg"}>
                      {specyficItem.minAttack} - {specyficItem.maxAttack}
                    </p>
                  </div>
                  <div className="equipmentValue">
                    <span style={{ color: "grey" }}>
                      {equipmentItem.minAttack} - {equipmentItem.maxAttack}
                    </span>
                  </div>
                  <div className="diffrenceValue">
                    {specyficItem.minAttack + specyficItem.maxAttack >= equipmentItem.minAttack + equipmentItem.maxAttack ? (
                      equipmentItem.minAttack + equipmentItem.maxAttack === specyficItem.minAttack + specyficItem.maxAttack ? (
                        <span style={{ color: "grey" }}>~{specyficItem.minAttack + specyficItem.maxAttack - (equipmentItem.minAttack + equipmentItem.maxAttack)}</span>
                      ) : (
              ...
              {specyficItem.defensive !== 0 ? (
                <div className="row">
                  <div className="statName">
                    <p className={"def"}>
                      <span className={"defd"}>Obrona:</span>
                    </p>
                  </div>
                  <div className="statValue">
                    <p className={"def"}>{specyficItem.defensive}</p>
                  </div>
                  <div className="equipmentValue">
                    <span style={{ color: "grey" }}>{equipmentItem.defensive}</span>
                  </div>
                  <div className="diffrenceValue">
              ...
              {specyficItem.strength !== 0 ? (
                <div className="row">
                  <div className="statName">
                    <p className={"str"}>
                      <span className={"strd"}>Siła:</span>
                    </p>
                  </div>
                  <div className="statValue">
                    <p className={"str"}>{specyficItem.strength}</p>
                  </div>
                  <div className="equipmentValue">
                    <span style={{ color: "grey" }}>{equipmentItem.strength}</span>
                  </div>
                  <div className="diffrenceValue">
                    {" "}
              ...
              {specyficItem.dexterity !== 0 ? (
                <div className="row">
                  <div className="statName">
                    <p className={"agl"}>
                      <span className={"agld"}>Zręczność:</span>
                    </p>
                  </div>
                  <div className="statValue">
                    <p className={"agl"}>{specyficItem.dexterity}</p>
                  </div>
                  <div className="equipmentValue">
                    <span style={{ color: "grey" }}>{equipmentItem.dexterity}</span>
                  </div>
                  <div className="diffrenceValue">
              ...
              {itemInUse.minAttack !== 0 || itemInUse.maxAttack !== 0 ? (
                <div className="row">
                  <div className="statName">
                    <p className={"int"}>
                      <span className={"intd"}>Inteligencja:</span>
                    </p>
                  </div>
                  <div className="statValue">
                    <p className={"int"}>{specyficItem.intellect}</p>
                  </div>
                  <div className="equipmentValue">
                    <span style={{ color: "grey" }}>{equipmentItem.intellect}</span>
                  </div>
                  <div className="diffrenceValue">
                    {" "}
              ...
              {itemInUse.minAttack !== 0 || itemInUse.maxAttack !== 0 ? (
                <div className="row">
                  <div className="statName">
                    <p className={"stm"}>
                      <span className={"stmd"}>Wytrzymałość:</span>
                    </p>
                  </div>
                  <div className="statValue">
                    <p className={"stm"}>{specyficItem.stamina}</p>
                  </div>
                  <div className="equipmentValue">
                    <span style={{ color: "grey" }}>{equipmentItem.stamina}</span>
                  </div>
                  <div className="diffrenceValue">
              ...
              {itemInUse.minAttack !== 0 || itemInUse.maxAttack !== 0 ? (
                <div className="row">
                  <div className="statName">
                    <p className={"luk"}>
                      <span className={"lukd"}>Szczęście:</span>
                    </p>
                  </div>
                  <div className="statValue">
                    <p className={"luk"}>{specyficItem.spirit}</p>
                  </div>
                  <div className="equipmentValue">
                    <span style={{ color: "grey" }}>{equipmentItem.spirit}</span>
                  </div>
                  <div className="diffrenceValue">
        ...
        <div className="sellInfo">Możliwa sprzedaż za: {specyficItem.cost} złota</div>
        <div className="inventoryItemButtons">
          <button
            id={"puton"}
            onClick={() => {
              changingButton(slotNumber, specyficItem);
            }}
          >
            {" "}
            Załóź
          ...
          <button
            id={"sell"}
            onClick={() => {
              sellingButton(slotNumber, specyficItem);
            }}
          >
            {" "}
            Sprzedaj
