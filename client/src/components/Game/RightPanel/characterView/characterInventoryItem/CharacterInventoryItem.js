...
const CharacterInventoryItem = ({typeOfPosition ,valueOfItem, specyficItem, slotNumber,sellThisItem,handleChangeItemIntoUse}) => {
    ...
    return (valueOfItem) ? (
        <div className="inventoryItem"  id={id}>
            ...
            <div className='inventoryItem' id={id}>
                ...
                <CharacterPopup handleChangeItemIntoUse={handleChangeItemIntoUse}  slotNumber={slotNumber} sellThisItem={sellThisItem}  valueOfPoup={popupValue} showPopup={showPopup} specyficItem={specyficItem} />
            </div>
        );
