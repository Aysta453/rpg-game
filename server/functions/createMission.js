export default function createMission(firstValue,secondValue,level,dificultMode) {
    ...
    monsterDefense = ((dificultMode * level) * 2) * Math.floor((Math.random() * 5) + 1);
    do {
        monsterMinAttack = ((dificultMode * level) * 1) * Math.floor((Math.random() * 5) + 1);
        monsterMaxAttack = ((dificultMode * level) * 2) * Math.floor((Math.random() * 5) + 1);
